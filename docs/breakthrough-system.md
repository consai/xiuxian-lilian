...
| 中央 | 角色立绘/打坐、**当前境界 → 目标境界**、进度条 `总计 / min_total`、状态文案（过低/可突破/推荐区间）与主要缺口 |
...
- 突破面板在分项、总分和品质档之外，显示“还差多少突破值 / 距下一品质还差多少 / 知识点门槛”之一，并列出当前可补空间最大的分项。
- 修炼结算提示修为项距离突破门槛的差额；修为已满时，引导玩家回突破面板看丹药、心境和根骨缺口。
- 炼丹结算提示聚气丹可在修炼界面补修为项。
- 历练结算提示战斗可压实灵力虚浮，带回药材可继续炼聚气丹。
...
| 日期 | 摘要 |
|------|------|
| 2026-06-24 | PM-205：突破面板补主要缺口；修炼、炼丹、历练结算补突破准备反馈 |
