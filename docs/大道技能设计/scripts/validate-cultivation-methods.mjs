...
const config = JSON.parse(await readFile(new URL("../config/cultivation_methods.json", import.meta.url), "utf8"));
const sharedCatalog = JSON.parse(await readFile(new URL("../config/effect_catalog.json", import.meta.url), "utf8"));
const errors = [];
