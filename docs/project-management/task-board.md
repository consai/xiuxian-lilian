...
描述：1. 优化战败、受伤、丹药、休息、结算奖励的体验，让失败不是重开式惩罚。
    2. 历练获得基础资源太少, 有时连一炉丹药都炼不了.
    3 .没有新的功法和技能学习.
...
- `docs/project-management/pm-401-recovery-failure-cost-design.md`

任务备注：

- 2026-06-25：完成恢复与失败成本详细设计；结算页底部已增加战败后恢复路径提示，代码与配置调参留给实现任务。
