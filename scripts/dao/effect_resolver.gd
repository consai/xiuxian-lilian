...
const EFFECT_TO_FIGHT := {
	"cast_speed": {EnumPlayerAttr.SPD: true},
	"physical_def": {EnumPlayerAttr.PHYSICAL_DEF: true},
	"magic_def": {EnumPlayerAttr.MAGIC_DEF: true},
	"all_resistance": {EnumPlayerAttr.PHYSICAL_DEF: true, EnumPlayerAttr.MAGIC_DEF: true},
	"damage_bonus": {EnumPlayerAttr.DAMAGE_BONUS: true},
	"hp_regen": {EnumPlayerAttr.HP_REGEN: true},
	"control_resist": {EnumPlayerAttr.CONTROL_RESIST: true},
	"max_hp": {EnumPlayerAttr.HP_MAX: true},
	"evasion_window": {EnumPlayerAttr.SPD: true},
	"mana_regen": {EnumPlayerAttr.MP_REGEN: true},
	"max_mana": {EnumPlayerAttr.MP_MAX: true},
	"max_health": {EnumPlayerAttr.HP_MAX: true},
	"health_regen": {EnumPlayerAttr.HP_REGEN: true},
	"physical_attack": {EnumPlayerAttr.PHYSICAL_ATK: true},
	"magic_attack": {EnumPlayerAttr.MAGIC_ATK: true},
	"physical_defense": {EnumPlayerAttr.PHYSICAL_DEF: true},
	"magic_defense": {EnumPlayerAttr.MAGIC_DEF: true},
	"sword_damage": {EnumPlayerAttr.DAMAGE_BONUS: true},
	"spell_damage": {EnumPlayerAttr.DAMAGE_BONUS: true},
	"thunder_damage": {EnumPlayerAttr.DAMAGE_BONUS: true},
	"melee_damage": {EnumPlayerAttr.DAMAGE_BONUS: true},
	"spirit_power": {EnumPlayerAttr.DAMAGE_BONUS: true},
	"poison_power": {EnumPlayerAttr.DAMAGE_BONUS: true},
	"curse_power": {EnumPlayerAttr.DAMAGE_BONUS: true},
	"tribulation_damage": {EnumPlayerAttr.DAMAGE_BONUS: true},
	"physical_resistance": {EnumPlayerAttr.PHYSICAL_DEF: true},
	"spiritual_resistance": {EnumPlayerAttr.MAGIC_DEF: true},
	"mental_resistance": {EnumPlayerAttr.MAGIC_DEF: true},
	"soul_resistance": {EnumPlayerAttr.MAGIC_DEF: true},
	"tribulation_resistance": {EnumPlayerAttr.MAGIC_DEF: true},
	"control_resistance": {EnumPlayerAttr.CONTROL_RESIST: true},
}
