class_name ZhandouSummary
extends RefCounted

const OUTCOME_WIN := ZhandouRecordTypes.OUTCOME_WIN
const OUTCOME_LOSS := ZhandouRecordTypes.OUTCOME_LOSS
const OUTCOME_DRAW := ZhandouRecordTypes.OUTCOME_DRAW
const OUTCOME_ESCAPED := ZhandouRecordTypes.OUTCOME_ESCAPED
