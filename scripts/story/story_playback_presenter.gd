...
@onready var _dialogue_label: Label = _dialogue.find_child("DialogueLabel", true, false) as Label
@onready var _continue_indicator: Control = _dialogue.find_child("ContinueIndicator", true, false) as Control
@onready var _speaker_label: Label = _dialogue.find_child("SpeakerLabel", true, false) as Label
@onready var _portrait_back: Control = _dialogue.find_child("PortraitBack", true, false) as Control
@onready var _portrait: TextureRect = _dialogue.find_child("Portrait", true, false) as TextureRect
@onready var _name_plate: Control = _dialogue.find_child("NamePlate", true, false) as Control
@onready var _choices: VBoxContainer = _choice_panel.find_child("Choices", true, false) as VBoxContainer
@onready var _choice_template: Button = _choice_panel.find_child("ChoiceA", true, false) as Button
@onready var _choice_template_b: Button = _choice_panel.find_child("ChoiceB", true, false) as Button
@onready var _choice_prompt_label: Label = _choice_panel.find_child("PromptLabel", true, false) as Label
@onready var _focus_prompt_label: Label = _focus_prompt.find_child("Label", true, false) as Label
