class_name ZhandouEvent
extends RefCounted

const TYPE_BUFF_TICK_DAMAGE := EnumZhandouEventType.LABEL_BUFF_TICK_DAMAGE
const TYPE_BUFF_EXPIRED := EnumZhandouEventType.LABEL_BUFF_EXPIRED
