...
static func _has_buff(unit: ZhandouObj, buff_id: String) -> bool:
	if unit == null:
		return false
...
static func _item_count_gte(enemy: ZhandouObj, value: Variant) -> bool:
...
static func _equip_ready(enemy: ZhandouObj, value: Variant, equip_cfg: Dictionary) -> bool:
	var slot_index := 0
