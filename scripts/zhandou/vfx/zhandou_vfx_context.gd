...
var settings: ZhandouVfxSettings
var overrides: Dictionary = {}
var actors: Dictionary = {} # unit_id -> ZhandouActorVfx
var preset_library: ZhandouVfxPresetLibrary
...
func get_vfx_for_role(role: String) -> ZhandouActorVfx:
	return get_vfx(_role_to_unit_id(role))


func get_vfx(unit_id: String) -> ZhandouActorVfx:
	return actors.get(unit_id.strip_edges(), null) as ZhandouActorVfx
...
func resolve_anchor(actor_vfx: ZhandouActorVfx, anchor_name: String) -> Variant:
	...
	match key:
		...
		_:
			push_warning("ZhandouVfxContext: 未知 anchor '%s'" % anchor_name)
			return actor_vfx.get_rest_position()
